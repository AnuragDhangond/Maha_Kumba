...
const LiveDarshanPage = () => {
    ...
    const fetchStreams = async (search = '', page = 1) => {
        setIsLoading(true);
        try {
        ...
        <div className="admin-page-content animate-fade-in">
            <div className="admin-header-flex">
                <div className="dashboard-header-modern">
                    ...
                    <p className="page-subtitle">Manage real-time spiritual broadcasts for pilgrims</p>
                </div>
                {editingStream && (
            ...
            <div className="emergency-banner-static">
                <div className="banner-context">
                    <div className="static-marker-sos" style={{ background: 'rgba(255, 82, 82, 0.08)' }}>
                        <div className="marker-inner" style={{ background: '#ff5252' }}></div>
                    </div>
                    <div>
                        <h2 className="title-static">Live Broadcast Registry</h2>
                        <span className="subtitle-static">Nashik 2027 • Virtual Spiritual Experience</span>
                    </div>
                </div>
                <div className="banner-metrics-static">
                    <div className="metric-box-fixed" style={{ borderBottom: '3px solid #ff5252' }}>
                        
                        <div className="m-vals">
                            <span className="digit">{totalElements}</span>
                            <span className="lab">Active Channels</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="form-filter-row" style={{ marginTop: '20px', marginBottom: '10px' }}>
                <input
                    type="text"
                    placeholder="Search streams by Title, Location or Status..."
                    value={searchTerm}
                        ...
                        <tbody>
                            {streams.length === 0 ? (
                                ...
                                streams.map(stream => (
                                    <tr key={stream.id}>
                                        <td>
                                            <div style={{ width: '70px', height: '50px', borderRadius: '8px', overflow: 'hidden', background: 'var(--admin-sidebar-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                {stream.imagePath ? (
                                                    <img src={`${baseURL}${stream.imagePath}`} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                                ) : null}
                                            </div>
                                        </td>
                                        <td>
